...
Route::get('/identify', [PlantIdentificationController::class, 'showUploadForm'])->name('identify.form');
Route::post('/identify', [PlantIdentificationController::class, 'identifyPlant'])->name('plant.identify');
